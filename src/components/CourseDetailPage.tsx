  ...
  modules: [
    {
      ...
      topics: [
        "Copilots and AI-augmented workflows in professional settings",
        "Retrieval Augmented Generation (RAG) fundamentals and use cases",
        "Reasoning models: how and when to use them",
        "Responsible AI use: bias, fairness, and ethical deployment",
      ],
    },
    {
      number: 2,
      ...
      topics: [
        "Advanced prompt patterns for creative and technical tasks",
        "Rapid prototyping: shipping functional products in hours",
    ...
    },
    {
      ...
      topics: [
        "AI agents: architecture, tool use, and memory systems",
        "Orchestration patterns for multi-agent workflows",
        "No-code and custom-coded agentic implementations",
        "Lightweight evaluation strategies for agentic pipelines",
      ],
    },
    {
      number: 4,
      ...
      topics: [
        "Building robust evaluation pipelines for AI systems",
        "Human oversight frameworks and rollout patterns",
        "Designing systems that support — not replace — human judgment",
        "Optional: multimodal generation techniques for live demos",
      ],
    },
    {
      number: 5,
      ...
      topics: [
        "Poster-session style showcase with live project demonstrations",
        "Present apps, websites, or AI agents addressing real-world problems",
        "Alumni voting: recognizing creativity, technical execution, and impact",
        "Capstone: translate GenAI concepts into functional, deployable solutions",
      ],
    },
  ],
  summary: {
