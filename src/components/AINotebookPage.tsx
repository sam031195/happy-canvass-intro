            ...
            >
              ...
              <div className="px-4 pb-5 pt-3 shrink-0 flex flex-col gap-2">
                ...
                <div className="flex items-center justify-center gap-3 py-1">
                  {/* Zotero */}
                  <button onClick={() => setSettingsOpen(true)} className="w-8 h-8 rounded-md flex items-center justify-center transition-opacity hover:opacity-80" style={{ background: "hsla(0, 55%, 45%, 0.9)" }} title="Zotero">
                    <span className="text-white font-bold text-sm" style={{ fontFamily: "serif" }}>Z</span>
                  </button>
                  {/* Mendeley */}
                  <button onClick={() => setSettingsOpen(true)} className="w-8 h-8 rounded-full flex items-center justify-center transition-opacity hover:opacity-80" style={{ background: "hsla(0, 50%, 35%, 0.9)" }} title="Mendeley">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><circle cx="8" cy="10" r="3" fill="white"/><circle cx="16" cy="10" r="3" fill="white"/></svg>
                  </button>
                  {/* OneDrive */}
                  <button onClick={() => setSettingsOpen(true)} className="w-8 h-8 rounded-md flex items-center justify-center transition-opacity hover:opacity-80" style={{ background: "hsla(230, 22%, 14%, 1)", border: "1px solid hsla(0,0%,100%,0.08)" }} title="OneDrive">
                    <svg width="18" height="12" viewBox="0 0 24 16" fill="none"><path d="M6 14c-2.2 0-4-1.8-4-4 0-1.9 1.3-3.4 3-3.9C5.5 3.2 8 1 11 1c2.5 0 4.6 1.5 5.5 3.6.3 0 .7-.1 1-.1 2.5 0 4.5 2 4.5 4.5S20 13.5 17.5 13.5H6Z" fill="hsla(207, 90%, 54%, 1)"/></svg>
                  </button>
                  {/* GitHub */}
                  <button onClick={() => setSettingsOpen(true)} className="w-8 h-8 rounded-md flex items-center justify-center transition-opacity hover:opacity-80" style={{ background: "hsla(230, 22%, 14%, 1)", border: "1px solid hsla(0,0%,100%,0.08)" }} title="GitHub">
                  ...
                  {/* Notion */}
                  <button onClick={() => setSettingsOpen(true)} className="w-8 h-8 rounded-md flex items-center justify-center transition-opacity hover:opacity-80" style={{ background: "hsla(230, 22%, 14%, 1)", border: "1px solid hsla(0,0%,100%,0.08)" }} title="Notion">
                    <span className="text-white font-bold text-sm" style={{ fontFamily: "serif" }}>N</span>
                  </button>
                  {/* More arrow */}
                  <button onClick={() => setSettingsOpen(true)} className="w-6 h-6 flex items-center justify-center transition-opacity hover:opacity-80" title="More integrations">
