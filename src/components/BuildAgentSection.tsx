    ...
    <section className="px-6 lg:px-10 py-4">
      ...
      >
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-0">
            ...
            <div className="flex-1 max-w-xl lg:pr-12">
              <h2 className="text-4xl lg:text-5xl font-bold text-[hsl(0,0%,10%)] leading-tight mb-6">
                <span className="text-[hsl(235,40%,50%)]">Build</span> your agent
              </h2>
            ...
            <div className="flex-1 flex flex-col items-center lg:items-start lg:pl-12 gap-4 pt-4">
              ...
              <div className="self-end">
                <div
                  ...
                  style={{
                    background: "linear-gradient(135deg, hsl(225,35%,32%) 0%, hsl(240,35%,52%) 100%)",
                  }}
                >
                  <div className="w-8 h-8 rounded-full bg-[hsl(235,35%,48%)] flex items-center justify-center">
              ...
              >
                ...
                >
                  <p className="text-sm text-[hsl(0,0%,15%)] leading-relaxed">
                    ...
                    <span className="text-[hsl(235,40%,50%)]">@user_flagged_for_fraud</span>
                  </p>
                ...
                <div className="space-y-4 text-sm leading-relaxed">
                  <p>
                    ...
                    <span className="text-[hsl(235,40%,50%)]">@load_user_orders</span>
                  </p>
                  <div>
                    <p>
                  ...
                  <div>
                    <p>
                      ...
                      <span className="text-[hsl(235,40%,50%)]">@order_exchange_eligible</span>
                    </p>
                    <p className="pl-4">
                      <span className="text-[hsl(0,0%,55%)]">a.</span>{" "}
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, hsla(235,40%,50%,0.06) 0%, transparent 70%)",
          }}
        />
      </div>
    </section>
