        ...
        <div className="px-10 lg:px-16 py-16 lg:py-20">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-0 overflow-hidden">
            ...
            <div className="hidden lg:flex flex-col items-center pt-4">
              <TimelineLine className="h-24" />
              <TimelineCircle number={1} />
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex justify-end mb-4">
                    <div className="rounded-full px-5 py-3 flex items-center gap-3 inline-flex" style={{ background: "hsl(252,50%,55%)" }}>
          ...
          {/* ===== STEP 2 ROW ===== */}
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-0 overflow-hidden mt-8 lg:mt-0">
            {/* Left */}
            <div className="flex-1 max-w-xl lg:pr-12 pt-8 lg:pt-16">
              <div
            ...
            <div className="hidden lg:flex flex-col items-center">
              <TimelineLine className="h-16" />
              <TimelineCircle number={2} />
              <TimelineLine className="flex-1" />
            </div>
